...
% temp5 = prY1+(dpressY/c_ang);                      %d=profondita` espressa come la derivata del raggio di curvatura
...
x_dot=[prY2;...
       ...
       (-1/tau_lp)*x_lp+(2/pi)*E*((prY1+(((pressY+q_lin)/c_ang)-r0))/((pressY+q_lin)/c_ang))^(1/2)];
